...
(function(){
    ...
    */
    ...
    // ?
    var text = "Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de maio de 1804 – Rio de Janeiro, 18 de dezembro de 1875), apelidado de \"O Centauro de Luvas\", foi um militar, político, abolicionista e monarquista brasileiro."
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Ana Carolina Barreto'));
    // ?
    ...
    */
    ...
    // ?
    console.log(text.replace(/brasileiro/g, 'Curitibana'));
    ...
    */
    ...
    function getMonthNumber(month) {
        //podia ter sido feito com um objeto
        var months = ['janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho', 
                        'julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro'];

        var selected = months.indexOf(month) + 1;

        (selected <= 0) 
        ? selected = "MES INVÁLIDO"
        : (selected < 10) ? selected = ('0' + selected) : selected = '' + selected;

        return selected;
    }
    var showMonth = function showMonth(month) {
    ...
    */
    ...
    var regexDate = /(\d\d) de (\w{4,}) de (\d{4})/g;
