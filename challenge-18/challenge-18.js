...
(function(){
    ...
    */
    ...
    function cleanCPF(number) {
        return number.replace(/\D/g, '');
    }

    var clean = cpf.map(function(item){
    ...
    */
    ...
    var formatted = clean.map(function(item){
        var regexCpf = /(\d{3})(\d{3})(\d{3})(\d{2})/g;
        return item.replace(regexCpf, function(){
    ...
    */
    ...
    // ?
    var testeString = "Os meses de janeiro, junho e julho começam com a letra j."
    console.log(testeString.match(/j\w{4}\s/g));
    ...
    */
    ...
    // ?
    var testeHtml = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
    console.log(testeHtml.match(/<\w+>/g));
    ...
    */
    ...
    // ?
    var htmlVazio = "<div><ul><li></li><li></li><li><span></span></li></ul></div>"; 
    console.log(htmlVazio.match(/(<\w+>)(<\/\w+>)/g));
    ...
    */
    ...
    function substituteText(regex, tagOpen, tagName, content, tagClose){
        console.log(arguments);
        return '\n'+ tagOpen + 'O texto dentro da tag "' + tagName +'" é "' + content + '"' + tagClose; 
        // ou 
        // return '<'+ tagName + '> O texto dentro da tag "' + tagName +'" é "' + content + '"</' + tagName + '>';
    }
    htmlReplace = htmlReplace.replace(regexCode , substituteText); 
