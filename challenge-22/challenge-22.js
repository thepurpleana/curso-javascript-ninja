(function(){
  ...
  */
  // ?
  var person1 = { name: 'Ana Carolina', lastName: 'Barreto'};
  var person2 = { name: 'Ana Julia', lastName: 'Barreto'};
  ...
  */
  ...
  function justNumbers(verify) {
    return verify.replace(/[^\d]+/g, ' ').split(' ');
  }
