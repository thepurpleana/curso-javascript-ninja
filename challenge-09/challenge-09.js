...
chamada.
*/
console.log( 'O resultado da subtração é:', subtraction(function(a, b) {
    return a - b; 
}) );
// ?

console.log( 'O resultado da multiplicação é:', multiplication(function(a, b) {
    return a * b; 
}) );
// ?

console.log( 'O resultado da divisão é:', division(function(a, b) {
    return a / b; 
}) );
// ?
